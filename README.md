...
This repository collects self-contained research dossiers on individual
Erdős problems. Each numbered directory contains the manuscript, literature
record, audits, reproducibility material, and available formal verification.

## Available dossiers

- [Problem 593](593/) — the maintained `Erdos593` repository, linked here as
  a Git submodule.
- [Problem 625](625/) — a proposed resolution of the chromatic–cochromatic
...
[Creative Commons Attribution 4.0 International License](LICENSE). When the
license requires attribution, credit **Samuil Petkov**, link to this
repository when reasonably practicable, identify CC BY 4.0, and state whether
changes were made. Scholarly users are also asked to cite the project using
