...
theorem cutoffComplementQuarterDensityEvent_quarterDense_exact_verified2
  ...
  have hEdgeCount : inducedComplementEdgeCount (↑S : Set (Fin n)) G =
...
theorem cutoffComplementQuarterDensityEvent_quarterDense_all_larger_verified2
    (n : ℕ) (G : LabeledGraph n)
    (hG : G ∈ cutoffComplementQuarterDensityEvent n)
  ...
  exact quarterDense_all_larger_of_all_exact Gᶜ (quarterDensityCutoff n)
    hcutoff (cutoffComplementQuarterDensityEvent_quarterDense_exact_verified2 n G hG)

#print axioms cutoffComplementQuarterDensityEvent_quarterDense_exact_verified2
#print axioms cutoffComplementQuarterDensityEvent_quarterDense_all_larger_verified2
