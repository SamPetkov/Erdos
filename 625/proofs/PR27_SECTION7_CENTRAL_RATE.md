# PR #27: Section 7 central-rate replacement

**Status.** This file is a review appendix and candidate replacement for the
most concentrated parts of the canonical manuscript.  It does not change the
theorem, constant, four class sizes, or proof architecture.  The finite maps,
fibre cardinalities, and inequality chains below are stated explicitly so that
they can be reviewed before any canonical integration.
