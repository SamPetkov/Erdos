...
\end{equation}
For a one-sided margin vector $r$ satisfying $0\le r_i\le k_i$, define
\begin{equation}
  D(r)=
...
\end{equation}
This is the partial-diagonal weight from Section~7. Every sum over $r$ below is
over this finite coordinate box; no value outside it is used.
