...
The phase dependence is genuine.  Put $\lambda_*=3q$ and
\[
 T_*:=M_{S_4}(\lambda_*)
...
$w_8=2^{-8}$ and has successive ratio at most $1/32$, so
\[
 \sum_{i\ge8}(i-3)w_i
...
$n-m=\sum_j u_j(k_j-\ell_j)\ge u_i$, the denominator below is nonzero.  Also,
...
For the remainder of this section, reindex the deficit labels by the bijection
...
For the remainder of this subsection, assume $\alpha>8$. This condition is
included in the common eventuality threshold of
Subsection~\ref{subsec:uniformity-phase-v3}.
...
The sets are nested and $S_{t+1}\subseteq N_H(v_t)$. Thus, whenever $s>t$,
\[
  v_s\in S_s\subseteq S_{t+1}\subseteq N_H(v_t).
\]
...
\[
  ...
  \right]s_n.
\]
By (10.4) and (10.11), a union bound shows that this intersection has
