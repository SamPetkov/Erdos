...
labeled configuration matchings by retaining the selected-pair set
$S\in\mathfrak F(P,j)$, and yields the displayed normalized factorization.}
...
revision pins Lean and Mathlib at version~4.31.0 and provides the modular
sources, a deterministically generated single-file closure, build
instructions, a trust-boundary audit, and a clean-environment replay record.
