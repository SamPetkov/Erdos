...
welded.  Their presence narrows the unresolved task, but it does not supply the
uniform asymptotic bridges needed by the manuscript.
...
\toprule
Manuscript role & Lean declaration & Status\\
\midrule
\endhead
...
Uniform central Stirling extraction & Exact finite-to-rate theorem & Needs review\\
...
inequalities.  What remains is to transport the exact factorial weights to that
rate uniformly in the complete phase, prove the empty- and full-corner
asymptotics for the midpoint profile, and assemble a disjoint and exhaustive
three-range partition.  The exact rational checker records only the constant
ledger for the scalar proof; it is not evidence for these asymptotic steps.
...
Section 7 & Prove the uniform empty-corner activity asymptotic, central Stirling
extraction, full-corner ratio estimate, and their normalized three-range
assembly.  The finite recurrence, scalar geometry, structural bridge, and
full-corner reindexing are welded. & Needs review\\
