...
$S\in\{S_+,S_4\}$ and $0\le c\le\log2$, the equation
\[
  L_S(n,k)+ck=0
\]
...
\[
  ...
  :=
  \max_{\substack{S\in\{S_+,S_4\}\\0\le c\le\log2}}
...
\begin{proof}
Put $q:=\log2$, $L:=\log n$, and $\ell:=\log\log n$.
