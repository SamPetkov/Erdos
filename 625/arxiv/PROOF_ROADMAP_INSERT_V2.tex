...
\[
  ...
  \prod_{e\in P}g(j_e).
  \tag{\ref{sec:proof-architecture}.1}
\]
No full completion is selected objectwise.  Formula
\eqref{sec:proof-architecture}.1 is obtained by summing the entire finite
physical fibre.
...
\[
  ...
  \tag{\ref{sec:proof-architecture}.2}
\]
