...
Search date: 2026-07-11. Entries are marked `verified-original` only after the
original HTML/PDF/text has been acquired and checked directly. Full theorem
wording, version diffs, and source-level warnings are in
`RECENT_WORK_AUDIT.md`; access failures are documented in
...
| 13 | Erdős–Gimbel (1993) | Ann. Discrete Math. 55, 261–264 | Metadata/abstract only; original full text not acquired | Publisher abstract only | Original quantifiers not independently read | Historical cochromatic source | Metadata searches complete | Mandatory-source failure; DOI verified |
| 14 | Gimbel (2016) | Springer chapter, 95–108 | Metadata/abstract/indexed snippets only; full text blocked | Problem/prize snippets visible, not full chapter | Original wording not independently read | Historical survey | Metadata searches complete | Mandatory-source failure; DOI verified |
| 15 | Bollobás (1988) | Combinatorica 8, 49–55 | Metadata/abstract only; original full text not acquired | First-order theorem corroborated by later primary sources | Original proof not independently read | Fixed `p`, ordinary `chi` | Repository searches complete | Mandatory-source failure; DOI verified |
...
| 18 | Janson–Łuczak–Ruciński (2000) | Wiley book | Publisher metadata/author TOC only; full book not acquired | Dense-colouring section identified as §7.4 | Exact theorem/page not original-verified | Random-graph reference text | N/A | Mandatory-source failure |
