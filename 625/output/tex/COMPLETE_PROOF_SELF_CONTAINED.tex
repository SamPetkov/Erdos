...
let \(m_0\) be its residual stub mass. Every unexposed high cell is then
in the range \(R_0<j\le3a/4+O(1)\). Let \(E_{mid}(S)\) be the
conditional bare middle-extension factor. If \(m_0\ge n/N^6\), expand
over distinct residual cells and their threshold demands. With
...
historical sources confirm the definition, the original divergence
question, and the standard first-order chromatic asymptotic; none
supplies a step of the proof above.
