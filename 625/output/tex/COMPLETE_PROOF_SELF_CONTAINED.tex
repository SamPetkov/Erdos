...
The divergence question was posed by Erd\H{o}s and Gimbel (1993, p.~263)
and restated by Gimbel (2016, Section 7.4, p.~100). For historical
comparison, the first-order dense-random-graph chromatic asymptotic is
due to Bollob\'{a}s (1988, Theorem 4); Janson, \L uczak, and
Ruci\'{n}ski (2000, Section 7.4, Theorem 7.14 and Remark 7.15) give a
textbook treatment. These references provide context only: the proof of
(0.1) below does not import their results.
...
by \(\mathbf 1_{\mathcal N(S)}\). Thus its finite threshold expansion is exact
on \(\mathcal N(S)\). After that nonnegative expansion, the indicator may be
dropped term by term; the local factor is still the truncated middle factor,
so no newly admitted near cell is charged as a middle cell. If
\(m_0\ge n/N^6\), expand over distinct residual cells and their threshold
demands. With
\(\theta_{ab}=e d_ad'_b/m_0\le ea^2/m_0\), Lemma 6.2 is applied jointly
...
al.~(2025), was used as an optional proof-search assistant on isolated atomic
...
\texttt{-{}-wfail}, and axiom-audited were accepted. Aristotle did not verify
or prove the full manuscript.

The public research dossier is available at
\url{https://github.com/SamPetkov/Erdos}. An accompanying Lean 4 development
is available at
...
\def\labelenumi{\arabic{enumi}.}
\item
  P. Erd\H{o}s and J. Gimbel, ``Some Problems and Results in Cochromatic
...
\item
  B. Bollob\'{a}s, ``The Chromatic Number of Random Graphs,''
...
\item
  Tudor Achim, Alex Best, Alberto Bietti, Kevin Der, Math\"{\i}s
  F\'{e}d\'{e}rico, Sergei Gukov, Daniel Halpern-Leistner,
  Kirsten Henningsgard, Yury Kudryashov, Alexander Meiburg,
  Martin Michelsen, Riley Patterson, Eric Rodriguez, Laura Scharff,
  Vikram Shanker, Vladmir Sicca, Hari Sowrirajan, Aidan Swope,
  Matyas Tamas, Vlad Tenev, Jonathan Thomm, Harold Williams, and
  Lawrence Wu, ``Aristotle: IMO-level Automated Theorem Proving,''
  arXiv:2510.01346 [cs.AI], 2025.
