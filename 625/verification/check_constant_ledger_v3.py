...
CANONICAL_RATIO = Fraction(200, 153)
FOURFOLD_SLACK_RATIO = Fraction(13600000000000000, 2961236335721049)
...
def main() -> None:
    ...
    require(
        STRONG_RATIO**4 / CANONICAL_RATIO == FOURFOLD_SLACK_RATIO > 1,
        "canonical final-constant slack failed",
    )
    ...
    print(f"  fourfold slack ratio over canonical target: {FOURFOLD_SLACK_RATIO}")
